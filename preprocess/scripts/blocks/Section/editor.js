...
export default class Editor extends Component {
  render = () => {
    const { padding, margin, backgroundImage, backgroundColor, backgroundSize, backgroundPosition, backgroundRepeat, borderWidth, borderStyle, borderColor, contentWidth, containerWidth, sectionPosition } = this.props.block.attributes
